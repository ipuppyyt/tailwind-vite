  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white">
      ...
      <main className="flex flex-col items-center">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-4 text-gray-400">
            Edit{" "}
            <code className="bg-gray-800 px-1 py-0.5 rounded">src/App.jsx</code>{" "}
      ...
      <footer className="mt-12 p-4 text-center text-gray-500 text-xs">
        <p>Click on the Vite, React or Sass logos to learn more</p>
        <div className="flex justify-center space-x-6 mt-2">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <img src="/assets/sass.svg" alt="Sass logo" className="w-10 h-10" />
          </a>
        </div>
      </footer>
    </div>
